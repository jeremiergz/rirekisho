    ...
    >
      <div className="flex xs:flex-col md:flex-row items-center justify-center xs:mb-4 md:mb-4">
        <div className="flex items-center xs:mb-2 md:mb-0 xs:mx-0 md:mx-4">
          <span className="font-semibold mr-1 text-sm text-gray-100 dark:text-slate-800">Made with</span>
          <HeartIcon height={14} width={14} />
          <span className="font-semibold ml-1 text-sm text-gray-100 dark:text-slate-800">using</span>
        </div>
        <div>
      ...
      <div className="flex flex-col items-center justify-center">
        <span className="font-semibold text-xs text-gray-200 dark:text-slate-900">{appDetails}</span>
        <Anchor className="leading-3" external href={sourceCodeURL}>
          <span className="border-b border-dotted border-gray-400 dark:border-[#16213d] text-2xs text-gray-400 dark:text-[#16213d]">
            source code
          </span>
        </Anchor>
      </div>
